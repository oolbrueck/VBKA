...
public class Keys {
    ...
    public static final UniqueKey<CategoryMatcherRecord> CONSTRAINT_99 = Internal.createUniqueKey(CategoryMatcher.CATEGORY_MATCHER, DSL.name("CONSTRAINT_99"), new TableField[] { CategoryMatcher.CATEGORY_MATCHER.ID }, true);
    ...
    public static final ForeignKey<CategoryRecord, UserTableRecord> CONSTRAINT_31 = Internal.createForeignKey(Category.CATEGORY, DSL.name("CONSTRAINT_31"), new TableField[] { Category.CATEGORY.FK_USER }, Keys.CONSTRAINT_C, new TableField[] { UserTable.USER_TABLE.NAME }, true);
    ...
    public static final ForeignKey<CategoryMatcherRCategoryRecord, CategoryMatcherRecord> CONSTRAINT_DF8 = Internal.createForeignKey(CategoryMatcherRCategory.CATEGORY_MATCHER_R_CATEGORY, DSL.name("CONSTRAINT_DF8"), new TableField[] { CategoryMatcherRCategory.CATEGORY_MATCHER_R_CATEGORY.FK_CATEGORY_MATCHER }, Keys.CONSTRAINT_99, new TableField[] { CategoryMatcher.CATEGORY_MATCHER.ID }, true);
